...
class Menu: SKScene {
    ...
    var AutoBalanceButton:SKSpriteNode!
    var FixedSpawnButton:SKSpriteNode!
    var ScatterShotButton:SKSpriteNode!
    var counter: Int = 0
    var counter2: Int = 0
    var counter3: Int = 0
            ...
            for touch in touches {
                ...
                if node.name == "Terrain" {
                   ...
                   // let label = self.childNode(withName: "Style") as? SKLabelNode
                    ...
                    gameScene.TerrainType = label!.text!
                    gameScene.PowerupType = label2!.text!
                    gameScene.SoundType = label3!.text!
